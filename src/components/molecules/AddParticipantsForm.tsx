      ...
      <VStack spacing="7">
        <FormControl>
          ...
          <FormLabel>
            ...
            <HStack sx={inputStyle} maxWidth="320px" padding="8px" justify="center" borderRadius="4px">
          ...
          <Input
            ...
            onKeyDown={(event) => handleEnterPressed(event, 'participantInput', participants, Role.Participant)}
          />
        </FormControl>
        <Divider m="3em 0" />
        <FormControl>
          <FormLabel sx={labelStyle}>Gi redigeringstilgang</FormLabel>
          <Input
            id="adminInput"
            sx={inputStyle}
            placeholder="Inviter administrator med epostadresse"
            onKeyDown={(event) => handleEnterPressed(event, 'adminInput', participants, Role.Admin)}
          />
        </FormControl>
      </VStack>
    </>
